<?php 
    ...
    class class_widget_ad_with_image extends WP_widget
    {
        ...
        function class_widget_ad_with_image()
        {
            ...
            $widget_ops=array('class' => 'class_widget_ad_with_image', 'description'=>'AA VMZ AD Image');
            $control_ops=array('width' =>200, 'height'=>350, 'id-base'=>'id-widget-ad-with-image');
            $this->WP_widget('class_widget_ad_with_image',__('AA VMZ AD image','thietkeweb.vietmoz.com'),$widget_ops,$control_ops);
        }
		...
		function form($instance)
        {
            ...
            <div class="list image">
				...
				<input class="url widefat" type="text"  id="<?php echo $this->get_field_id('image'); ?>-image-url" name="<?php echo $this->get_field_name('image'); ?>" value="<?php echo $instance['image']; ?>"  />
				
                <input type="button" class="button-upload" id="<?php echo $this->get_field_id('image'); ?>-image"  value="Upload" />
				<input type="button" class="button-remove" id="<?php echo $this->get_field_id('image'); ?>-image-" value="Remove" />
				<br />
				<img style="max-width:100%" class="image-img" id="<?php echo $this->get_field_id('image'); ?>-image-display" src="<?php echo $instance['image']; ?>"/>                    
			</div>
